...
class Elfin(KaitaiStruct):
    ...
    class ElfinTlmData(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.elfin_hskp_pwr1_adc_data_adc_sa_volt_12 = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_adc_sa_volt_34 = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_adc_sa_volt_56 = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_sa_short_circuit_current = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_bat_2_volt = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_bat_1_volt = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_reg_sa_volt_1 = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_reg_sa_volt_2 = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_reg_sa_volt_3 = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_power_bus_current_1 = self._io.read_s2le()
            self.elfin_hskp_pwr1_adc_data_power_bus_current_2 = self._io.read_s2le()
            ...
            self.elfin_hskp_pwr1_bv_mon = self._io.read_s2le()
            ...
            self.elfin_hskp_pwr2_adc_data_adc_sa_volt_12 = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_adc_sa_volt_34 = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_adc_sa_volt_56 = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_sa_short_circuit_current = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_bat_2_volt = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_bat_1_volt = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_reg_sa_volt_1 = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_reg_sa_volt_2 = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_reg_sa_volt_3 = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_power_bus_current_1 = self._io.read_s2le()
            self.elfin_hskp_pwr2_adc_data_power_bus_current_2 = self._io.read_s2le()
            ...
            self.elfin_acb_pc_data1_tmps_tmp1 = self._io.read_s2le()
            self.elfin_acb_pc_data1_tmps_tmp2 = self._io.read_s2le()
            self.elfin_acb_pc_data1_tmps_tmp3 = self._io.read_s2le()
            self.elfin_acb_pc_data1_tmps_tmp4 = self._io.read_s2le()
            ...
            self.elfin_acb_pc_data2_tmps_tmp1 = self._io.read_s2le()
            self.elfin_acb_pc_data2_tmps_tmp2 = self._io.read_s2le()
            self.elfin_acb_pc_data2_tmps_tmp3 = self._io.read_s2le()
            self.elfin_acb_pc_data2_tmps_tmp4 = self._io.read_s2le()
            self.elfin_acb_sense_adc_data_current = self._io.read_s2le()
            self.elfin_acb_sense_adc_data_voltage = self._io.read_s2le()
